...
#include "CDialogitem.hpp"
															...
															ety::CCreditsState::CCreditsState				( const std::string& strStateName )
																: CDialogGameState( strStateName )
{
}

															ety::CCreditsState::~CCreditsState				( void )
{
}

void														ety::CCreditsState::on_Enter					( ety::CRessourceManager* const p_c_etyCurrentRessourceManager, ety::CGamesettings* const p_c_etyCurrentGamesettingManager )
{
}
void														ety::CCreditsState::on_Exit						( ety::CRessourceManager* const p_c_etyCurrentRessourceManager, ety::CGamesettings* const p_c_etyCurrentGamesettingManager )
{
}

void														ety::CCreditsState::init_GameState				( ety::CRessourceManager* const p_c_etyCurrentRessourceManager, ety::CGamesettings* const p_c_etyCurrentGamesettingManager )
{
...
const ety::GameStateRunning::en_etyGameStateRunning			ety::CCreditsState::handle_GameStateEvents		( const sf::Event& sfEventLastEvent  )
{
