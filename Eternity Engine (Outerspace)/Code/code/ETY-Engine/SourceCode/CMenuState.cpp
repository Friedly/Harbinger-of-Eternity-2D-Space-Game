...
void														ety::CMenuState::init_GameState					( ety::CRessourceManager* const p_c_etyCurrentRessourceManager, ety::CGamesettings* const p_c_etyCurrentGamesettingManager )
{
	...
	sf::Music*	c_sfMusicMenuMusic	=	p_c_etyCurrentRessourceManager->get_Music("Menu.wav");
	c_sfMusicMenuMusic->play();
	////////////////////////////////////////////*Background ANFANG*////////////////////////////////////////////

	//http://cllips.com/wp-content/uploads/2012/12/2534560_1.jpg
