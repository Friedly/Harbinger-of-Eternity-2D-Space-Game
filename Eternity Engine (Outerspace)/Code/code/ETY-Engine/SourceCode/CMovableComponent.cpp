...
//#########################################################################################################//
			...
			void			ety::CMovableNPCComponent::set_DetectionRadius							( const float& fDetectionRadius )
			{
				m_fDetectionRadius	=	fDetectionRadius;
			}
...
const		float&			ety::CMovableNPCComponent::get_DetectionRadius							( void )
			{
