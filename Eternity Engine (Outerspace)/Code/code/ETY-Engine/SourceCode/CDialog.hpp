...
namespace ety
{
	...
	protected:
		...
		enum	Anchor::en_etyAnchor			m_en_etyAnchor;
				...
				ety::CButton*					mp_c_etyButtonTooltip;
	...
	public:
				...
				/// \rückgabe	void
				///////////////////////////////////////////////////////////////////////////////////
				bool							add_Dialogitem						( CDialogitem* const p_c_DialogitemNewDialogitem, bool bNewDialogitem );
				///////////////////////////////////////////////////////////////////////////////////
				/// \Beschreibung: 
				...
				void							set_TooltipButton					(CButton* const p_c_etyButtonTooltip);
