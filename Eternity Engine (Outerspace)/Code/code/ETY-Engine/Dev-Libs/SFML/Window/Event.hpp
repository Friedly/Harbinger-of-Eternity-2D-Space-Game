...
public :
    ...
    enum EventType
    {
		...
		MouseButtonNoFocusReleased, ///< A mouse button was released, without focusing a ety::GUI Element (only works with the Eternity-Engine-Dialogsystem)
		MouseButtonDoubleClick,		///< A mouse button was doubleclicked (only works with the Eternity-Engine-Dialogsystem)
