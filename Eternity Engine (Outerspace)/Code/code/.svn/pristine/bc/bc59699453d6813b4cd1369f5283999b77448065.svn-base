...
//#########################################################################################################//
		...
		void							ety::CRenderComponent::set_Angle												( const float fAngle )
		{
			m_fAngle = fAngle;
...
//#########################################################################################################//
		...
		void							ety::CAnimationRenderComponent::set_Angle										( const float fAngle )
		{
			CRenderComponent::set_Angle( fAngle );
...
//#########################################################################################################//
		...
		void							ety::CStaticRenderComponent::set_Angle											( const float fAngle )
		{
			CRenderComponent::set_Angle( fAngle );
...
//#########################################################################################################//
			...
			void						ety::CStaticBackgroundRenderComponent::set_Angle								( const float fAngle )
			{
				CRenderComponent::set_Angle( fAngle );
